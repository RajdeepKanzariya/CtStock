    ...
    return (
        <div style={{ width: "100%", boxSizing: "border-box" }}>
            ...
            >
                ...
                <h1 style={{ margin: "12px 0 0", fontSize: "clamp(28px, 4vw, 42px)", fontWeight: 800, color: "#0F172A", lineHeight: 1.2 }}>
                    Explore All Our <span style={{ color: "#2563EB" }}>Products</span>
                </h1>
                <p style={{ margin: "14px auto 0", fontSize: "15.5px", color: "#64748B", maxWidth: "560px", lineHeight: 1.75 }}>
